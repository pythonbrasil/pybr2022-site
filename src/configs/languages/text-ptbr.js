...
import Elloa from "@images/keynotes/elloa.png";
import Guilherme from "@images/keynotes/guilherme.png";
...
export const TEXT_PTBR = {
  HOME: {
    ...
    ESPCACOOCEAN: {
      ...
      DESCRIPTION: "Os tutoriais e sprints acontecerão na Escola Superior de Tecnologia - EST/UEA e no espaço Samsung OCEAN Manaus.",
    },
    SPONSORING: {
