        ...
        <div className="container">
            ...
            <div className="col-lg-6 order-1 order-lg-0">
              <div>
                <div className="testimonial">
                  ...
                  <a href="https://www.linkedin.com/in/dunossauro" target="_blank">
                  ...
                  <a href="https://twitter.com/dunossauro?t=HH4wTdfJybyHpB53qeukvw&s=09" target="_blank">
                  ...
                  <a href="https://linktr.ee/dunossauro" target="_blank">
          ...
          <div className="row align-items-center mb-5">
            ...
            <div className="col-lg-6">
              <div>
                <div className="testimonial">
                  <h2>Elloá B. Guedes</h2>
                  <p>
                    Elloá B. Guedes é doutora em Ciência da Computação e
                    atua como Professora Adjunta da Universidade do
                    Estado do Amazonas desde 2013. É uma das co-fundadores
                    do Laboratório de Sistemas Inteligentes da instituição,
                    no qual desenvolve pesquisas com modelos, métodos, técnicas
                    e tecnologias de vanguarda da Ciência de Dados para problemas
                    contemporâneos. É uma entusiasta Python, colaborou na
                    fundação do Grupo PyLadies Manaus e curte um bom café!
                  </p>

                  <a href="https://github.com/elloa" target="_blank">
                  ...
                  <a href="http://www.elloaguedes.com/" target="_blank">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="bi bi-link-45deg" viewBox="0 0 16 16">
                      <path d="M4.715 6.542 3.343 7.914a3 3 0 1 0 4.243 4.243l1.828-1.829A3 3 0 0 0 8.586 5.5L8 6.086a1.002 1.002 0 0 0-.154.199 2 2 0 0 1 .861 3.337L6.88 11.45a2 2 0 1 1-2.83-2.83l.793-.792a4.018 4.018 0 0 1-.128-1.287z"/>
                      <path d="M6.586 4.672A3 3 0 0 0 7.414 9.5l.775-.776a2 2 0 0 1-.896-3.346L9.12 3.55a2 2 0 1 1 2.83 2.83l-.793.792c.112.42.155.855.128 1.287l1.372-1.372a3 3 0 1 0-4.243-4.243L6.586 4.672z"/>
                    </svg>
              ...
              <div>
                <div className="testimonial">
                  ...
                  <p>Oceanógrafa de formação, Letícia mudou de sua formação para uma carreira em
                    ...
                    Ela também é professora da plataforma do LinkedIn Learning
                    onde seus cursos têm ajudado milhares de alunos.
                  </p>
                  ...
                  <a href="https://twitter.com/leleportella?t=NWmaCL7oNr1Xtr_JZ15rhQ&s=09" target="_blank">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="bi bi-twitter" viewBox="0 0 16 16">
                      <path d="M5.026 15c6.038 0 9.341-5.003 9.341-9.334 0-.14 0-.282-.006-.422A6.685 6.685 0 0 0 16 3.542a6.658 6.658 0 0 1-1.889.518 3.301 3.301 0 0 0 1.447-1.817 6.533 6.533 0 0 1-2.087.793A3.286 3.286 0 0 0 7.875 6.03a9.325 9.325 0 0 1-6.767-3.429 3.289 3.289 0 0 0 1.018 4.382A3.323 3.323 0 0 1 .64 6.575v.045a3.288 3.288 0 0 0 2.632 3.218 3.203 3.203 0 0 1-.865.115 3.23 3.23 0 0 1-.614-.057 3.283 3.283 0 0 0 3.067 2.277A6.588 6.588 0 0 1 .78 13.58a6.32 6.32 0 0 1-.78-.045A9.344 9.344 0 0 0 5.026 15z"/>
                    </svg>
                  </a>

                  <a href="https://leportella.com/" target="_blank">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="bi bi-link-45deg" viewBox="0 0 16 16">
                      <path d="M4.715 6.542 3.343 7.914a3 3 0 1 0 4.243 4.243l1.828-1.829A3 3 0 0 0 8.586 5.5L8 6.086a1.002 1.002 0 0 0-.154.199 2 2 0 0 1 .861 3.337L6.88 11.45a2 2 0 1 1-2.83-2.83l.793-.792a4.018 4.018 0 0 1-.128-1.287z"/>
                      <path d="M6.586 4.672A3 3 0 0 0 7.414 9.5l.775-.776a2 2 0 0 1-.896-3.346L9.12 3.55a2 2 0 1 1 2.83 2.83l-.793.792c.112.42.155.855.128 1.287l1.372-1.372a3 3 0 1 0-4.243-4.243L6.586 4.672z"/>
                    </svg>
